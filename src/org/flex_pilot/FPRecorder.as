  ...
  public class FPRecorder {
   ...
   /* private static var listItems:Array = [];
	...
	private static function makeFlex4Compatible():void{
		...
		//var regx:RegExp=new RegExp('\\[class (.*)\\]');  [only few of the components have been put into spark.components and so will load them directly]
    ...
    public static function handleEvent(e:*):void {
	  ...
	  /*try{
        ...
        FP::complete  {
          switch(true) {
              ...
              case (((e is ListEvent || e is IndexChangedEvent || e is eventMap[IndexChangedEvent]) && ( targ is ComboBox || targ is componentMap[ComboBox] || targ is ListBase || targ is componentMap[ListBase] || targ is AdvancedListBase) ) && e.type==ListEvent.CHANGE) :
      ...
      if (condTest) {
        switch (true) {
          ...
          case (((e is ListEvent || e is IndexChangedEvent || e is eventMap[IndexChangedEvent])&& ( targ is ComboBox || targ is componentMap[ComboBox] || targ is ListBase || targ is componentMap[ListBase]) ) && e.type==ListEvent.CHANGE) :
      ...
      private static function generateAction(t:String, targ:*,
          ...
          switch (t) {
            ...
            case 'select':
				...
				// In case of components like ComboBox(in Flex3) property selectedItems is not present but is there in case of other List based components and in flex4 combobox .
				...
				// If labelField is not equal to 'label' then the item to be selected is compared with data in labelField property .
